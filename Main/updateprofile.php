...
<<<<<<< HEAD
										<input type="text" name="fname" class="form-control" value="First name">
=======
...
>>>>>>> 7e6098ba4255aee706079c3e4fcd207e1a2d568a
								...
								<div class="row mb-3">
									...
									<div class="col-sm-9 text-secondary">
<<<<<<< HEAD
										<input type="text" name="lname" class="form-control" value="Last Name">
=======
...
>>>>>>> 7e6098ba4255aee706079c3e4fcd207e1a2d568a
								...
								<div class="row mb-3">
									...
									<div class="col-sm-9 text-secondary">
<<<<<<< HEAD
										<input type="text" name="github" class="form-control" value="github.com">
=======
...
>>>>>>> 7e6098ba4255aee706079c3e4fcd207e1a2d568a
								...
								<div class="row mb-3">
									...
									<div class="col-sm-9 text-secondary">
<<<<<<< HEAD
										<input type="text" name="twitter" class="form-control" value="twitter.com">
=======
...
>>>>>>> 7e6098ba4255aee706079c3e4fcd207e1a2d568a
								...
								<div class="row mb-3">
									...
									<div class="col-sm-9 text-secondary">
<<<<<<< HEAD
										<input type="text" name="facebook" class="form-control" value="facebook.com">
=======
...
>>>>>>> 7e6098ba4255aee706079c3e4fcd207e1a2d568a
								...
								<div class="row">
									...
									<div class="col-sm-9 text-secondary">
<<<<<<< HEAD
										<a type="submit" name="update" class="btn btn-primary px-4" href = "profilepage.php"> UPDATE </a>
=======
